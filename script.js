...
function calculateBudget() {
  const budgetValue = parseFloat(totalIncome.innerHTML.replace(/,/g, "")) - parseFloat(totalExpense.innerHTML.replace(/,/g, ""));
  budget.innerHTML = formatMoney(budgetValue);
}
calculateBudget();
...
function addEntry() {
  ...
  const deleteClass = type === "income" ? "delete-income" : "delete-expense";
